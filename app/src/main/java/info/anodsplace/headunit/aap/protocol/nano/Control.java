...
public interface Control {
  ...
  public static final class Service extends
    ...
    public static final class SensorSourceService extends
      ...
      public static final class Sensor extends
        ...
        // required .info.anodsplace.headunit.aap.protocol.SensorType type = 1;
        public int type;
      ...
      // repeated .info.anodsplace.headunit.aap.protocol.Service.SensorSourceService.Sensor sensors = 1;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor[] sensors;
      ...
      public SensorSourceService clear() {
        sensors = info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor.emptyArray();
        cachedSize = -1;
        return this;
      }
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        ...
        if (this.sensors != null && this.sensors.length > 0) {
          for (int i = 0; i < this.sensors.length; i++) {
            info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor element = this.sensors[i];
            if (element != null) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor[] newArray =
                  new info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor[i + arrayLength];
              if (i != 0) {
                java.lang.System.arraycopy(this.sensors, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService.Sensor();
    ...
    public static final class MediaSinkService extends
      ...
      public static final class VideoConfiguration extends
        ...
        // required .info.anodsplace.headunit.aap.protocol.Service.MediaSinkService.VideoConfiguration.VideoCodecResolutionType codec_resolution = 1;
        public int codecResolution;

        // required .info.anodsplace.headunit.aap.protocol.Service.MediaSinkService.VideoConfiguration.VideoFrameRateType frame_rate = 2;
        ...
        public VideoConfiguration clear() {
          codecResolution = info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_RESOLUTION_800x480;
          frameRate = info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_FPS_30;
          marginWidth = 0;
          marginHeight = 0;
          density = 0;
          ...
          while (true) {
            ...
            switch (tag) {
              ...
              case 8: {
                int value = input.readInt32();
                switch (value) {
                  case info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_RESOLUTION_800x480:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_RESOLUTION_1280x720:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_RESOLUTION_1920x1080:
              ...
              case 16: {
                int value = input.readInt32();
                switch (value) {
                  case info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_FPS_30:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.VIDEO_FPS_60:
      ...
      // required .info.anodsplace.headunit.aap.protocol.MediaCodecType available_type = 1;
      public int availableType;

      // required .info.anodsplace.headunit.aap.protocol.AudioStreamType audio_type = 2;
      public int audioType;

      // repeated .info.anodsplace.headunit.aap.protocol.AudioConfiguration audio_configs = 3;
      public info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration[] audioConfigs;

      // repeated .info.anodsplace.headunit.aap.protocol.Service.MediaSinkService.VideoConfiguration video_configs = 4;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration[] videoConfigs;
      ...
      public MediaSinkService clear() {
        availableType = info.anodsplace.headunit.aap.protocol.nano.Media.MEDIA_CODEC_AUDIO;
        audioType = info.anodsplace.headunit.aap.protocol.nano.Media.CAR_STREAM_SYSTEM;
        audioConfigs = info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration.emptyArray();
        videoConfigs = info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration.emptyArray();
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        ...
        if (this.audioConfigs != null && this.audioConfigs.length > 0) {
          for (int i = 0; i < this.audioConfigs.length; i++) {
            info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration element = this.audioConfigs[i];
            if (element != null) {
        ...
        if (this.videoConfigs != null && this.videoConfigs.length > 0) {
          for (int i = 0; i < this.videoConfigs.length; i++) {
            info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration element = this.videoConfigs[i];
            if (element != null) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              int value = input.readInt32();
              switch (value) {
                case info.anodsplace.headunit.aap.protocol.nano.Media.MEDIA_CODEC_AUDIO:
                case info.anodsplace.headunit.aap.protocol.nano.Media.MEDIA_CODEC_VIDEO:
            ...
            case 16: {
              int value = input.readInt32();
              switch (value) {
                case info.anodsplace.headunit.aap.protocol.nano.Media.CAR_STREAM_SYSTEM:
                case info.anodsplace.headunit.aap.protocol.nano.Media.CAR_STREAM_VOICE:
                case info.anodsplace.headunit.aap.protocol.nano.Media.CAR_STREAM_MEDIA:
            ...
            case 26: {
              ...
              info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration[] newArray =
                  new info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration[i + arrayLength];
              if (i != 0) {
                java.lang.System.arraycopy(this.audioConfigs, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration();
                input.readMessage(newArray[i]);
                input.readTag();
              }
              // Last one without readTag.
            ...
            case 34: {
              ...
              info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration[] newArray =
                  new info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration[i + arrayLength];
              if (i != 0) {
                java.lang.System.arraycopy(this.videoConfigs, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService.VideoConfiguration();
                input.readMessage(newArray[i]);
                input.readTag();
              }
              // Last one without readTag.
    ...
    public static final class InputSourceService extends
      ...
      // required .info.anodsplace.headunit.aap.protocol.Service.InputSourceService.TouchConfig touchscreen = 2;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService.TouchConfig touchscreen;

      // required .info.anodsplace.headunit.aap.protocol.Service.InputSourceService.TouchConfig touchpad = 3;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService.TouchConfig touchpad;
      ...
      public InputSourceService mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              if (this.touchscreen == null) {
                this.touchscreen = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService.TouchConfig();
              }
            ...
            case 26: {
              if (this.touchpad == null) {
                this.touchpad = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService.TouchConfig();
              }
    ...
    public static final class MediaSourceService extends
      ...
      // required .info.anodsplace.headunit.aap.protocol.MediaCodecType type = 1;
      public int type;

      // required .info.anodsplace.headunit.aap.protocol.AudioConfiguration audio_config = 2;
      public info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration audioConfig;
      ...
      public MediaSourceService clear() {
        type = info.anodsplace.headunit.aap.protocol.nano.Media.MEDIA_CODEC_AUDIO;
        audioConfig = null;
        availableWhileInCall = false;
        cachedSize = -1;
        return this;
      ...
      public MediaSourceService mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              if (this.audioConfig == null) {
                this.audioConfig = new info.anodsplace.headunit.aap.protocol.nano.Media.AudioConfiguration();
              }
    ...
    public static final class BluetoothService extends
      ...
      // repeated .info.anodsplace.headunit.aap.protocol.BluetoothPairingMethod supported_pairing_methods = 2;
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              for (int i = 0; i < length; i++) {
                ...
                int value = input.readInt32();
                switch (value) {
                  case info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_1:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_A2DP:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_3:
                  case info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_HFP:
    ...
    public static final class NavigationStatusService extends
      ...
      // optional .info.anodsplace.headunit.aap.protocol.Service.NavigationStatusService.ImageOptions image_options = 3;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.NavigationStatusService.ImageOptions imageOptions;
      ...
      public NavigationStatusService mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 26: {
              if (this.imageOptions == null) {
                this.imageOptions = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.NavigationStatusService.ImageOptions();
              }
    ...
    public static final class PhoneStatus_Call extends
      ...
      // optional .info.anodsplace.headunit.aap.protocol.Service.PhoneStatus_State state = 1;
      public int state;
      ...
      public PhoneStatus_Call clear() {
        state = info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_InCall;
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
          throws java.io.IOException {
        if (this.state != info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_InCall) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              int value = input.readInt32();
              switch (value) {
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_InCall:
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_OnHold:
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_HangingUp:
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_Incoming:
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_Muted:
                case info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_State_Conferenced:
                  this.state = value;
                  break;
              }
              break;
    ...
    public static final class PhoneStatusService extends
      ...
      // repeated .info.anodsplace.headunit.aap.protocol.Service.PhoneStatus_Call calls = 1;
      public info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call[] calls;
      ...
      public PhoneStatusService clear() {
        calls = info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call.emptyArray();
        signalStrength = 0;
        cachedSize = -1;
        return this;
      }
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        ...
        if (this.calls != null && this.calls.length > 0) {
          for (int i = 0; i < this.calls.length; i++) {
            info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call element = this.calls[i];
            if (element != null) {
              output.writeMessage(1, element);
            }
          }
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call[] newArray =
                  new info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call[i + arrayLength];
              if (i != 0) {
                java.lang.System.arraycopy(this.calls, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatus_Call();
                input.readMessage(newArray[i]);
                input.readTag();
              }
              // Last one without readTag.
    ...
    // optional .info.anodsplace.headunit.aap.protocol.Service.SensorSourceService sensor_source_service = 2;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService sensorSourceService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.MediaSinkService media_sink_service = 3;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService mediaSinkService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.InputSourceService input_source_service = 4;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService inputSourceService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.MediaSourceService media_source_service = 5;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSourceService mediaSourceService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.BluetoothService bluetooth_service = 6;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.BluetoothService bluetoothService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.NavigationStatusService navigation_status_service = 8;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.NavigationStatusService navigationStatusService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.MediaPlaybackStatusService media_playback_service = 9;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaPlaybackStatusService mediaPlaybackService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.PhoneStatusService phone_status_service = 10;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatusService phoneStatusService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.VendorExtensionService vendor_extension_service = 12;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.VendorExtensionService vendorExtensionService;

    // optional .info.anodsplace.headunit.aap.protocol.Service.GenericNotificationService generic_notification_service = 13;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service.GenericNotificationService genericNotificationService;
    ...
    public Service mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 18: {
            if (this.sensorSourceService == null) {
              this.sensorSourceService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.SensorSourceService();
            }
          ...
          case 26: {
            if (this.mediaSinkService == null) {
              this.mediaSinkService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSinkService();
            }
          ...
          case 34: {
            if (this.inputSourceService == null) {
              this.inputSourceService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.InputSourceService();
            }
          ...
          case 42: {
            if (this.mediaSourceService == null) {
              this.mediaSourceService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaSourceService();
            }
          ...
          case 50: {
            if (this.bluetoothService == null) {
              this.bluetoothService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.BluetoothService();
            }
          ...
          case 66: {
            if (this.navigationStatusService == null) {
              this.navigationStatusService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.NavigationStatusService();
            }
          ...
          case 74: {
            if (this.mediaPlaybackService == null) {
              this.mediaPlaybackService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.MediaPlaybackStatusService();
            }
          ...
          case 82: {
            if (this.phoneStatusService == null) {
              this.phoneStatusService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.PhoneStatusService();
            }
          ...
          case 98: {
            if (this.vendorExtensionService == null) {
              this.vendorExtensionService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.VendorExtensionService();
            }
          ...
          case 106: {
            if (this.genericNotificationService == null) {
              this.genericNotificationService = new info.anodsplace.headunit.aap.protocol.nano.Control.Service.GenericNotificationService();
            }
  ...
  public static final class ServiceDiscoveryResponse extends
    ...
    // repeated .info.anodsplace.headunit.aap.protocol.Service services = 1;
    public info.anodsplace.headunit.aap.protocol.nano.Control.Service[] services;
    ...
    public ServiceDiscoveryResponse clear() {
      services = info.anodsplace.headunit.aap.protocol.nano.Control.Service.emptyArray();
      make = "";
      model = "";
      year = "";
      vehicleId = "";
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.services != null && this.services.length > 0) {
        for (int i = 0; i < this.services.length; i++) {
          info.anodsplace.headunit.aap.protocol.nano.Control.Service element = this.services[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            info.anodsplace.headunit.aap.protocol.nano.Control.Service[] newArray =
                new info.anodsplace.headunit.aap.protocol.nano.Control.Service[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.services, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Control.Service();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class ByeByeRequest extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.ByeByeRequest.ByeByeReason reason = 1;
    public int reason;
    ...
    public ByeByeRequest clear() {
      reason = info.anodsplace.headunit.aap.protocol.nano.Control.ByeByeRequest.REASON_QUIT;
      cachedSize = -1;
      return this;
    }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.ByeByeRequest.REASON_QUIT:
                this.reason = value;
                break;
            }
            break;
  ...
  public static final class VoiceSessionNotification extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.VoiceSessionNotification.VoiceSessionStatus status = 1;
    public int status;
    ...
    public VoiceSessionNotification clear() {
      status = info.anodsplace.headunit.aap.protocol.nano.Control.VoiceSessionNotification.VOICE_STATUS_START;
      cachedSize = -1;
      return this;
    }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.VoiceSessionNotification.VOICE_STATUS_START:
              case info.anodsplace.headunit.aap.protocol.nano.Control.VoiceSessionNotification.VOICE_STATUS_STOP:
                this.status = value;
                break;
            }
            break;
  ...
  public static final class AudioFocusRequestNotification extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.AudioFocusRequestNotification.AudioFocusRequestType request = 1;
    public int request;
    ...
    public AudioFocusRequestNotification clear() {
      request = info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_GAIN;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.request != info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_GAIN) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_GAIN:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_RELEASE:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusRequestNotification.AUDIOFOCUS_NONE:
                this.request = value;
                break;
            }
            break;
  ...
  public static final class AudioFocusNotification extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.AudioFocusNotification.AudioFocusStateType focus_state = 1;
    ...
    public AudioFocusNotification clear() {
      focusState = info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN;
      unsolicited = false;
      cachedSize = -1;
      return this;
    }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT_CAN_DUCK:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_MEDIA_ONLY:
              case info.anodsplace.headunit.aap.protocol.nano.Control.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT_GUIDANCE_ONLY:
  ...
  public static final class NavFocusRequestNotification extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.NavFocusType focus_type = 1;
    ...
    public NavFocusRequestNotification clear() {
      focusType = info.anodsplace.headunit.aap.protocol.nano.Control.NAV_FOCUS_1;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.focusType != info.anodsplace.headunit.aap.protocol.nano.Control.NAV_FOCUS_1) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.NAV_FOCUS_1:
              case info.anodsplace.headunit.aap.protocol.nano.Control.NAV_FOCUS_2:
  ...
  public static final class NavFocusNotification extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.NavFocusType focus_type = 1;
    public int focusType;
  ...
  public static final class BluetoothPairingRequest extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.BluetoothPairingMethod pairing_method = 2;
    ...
    public BluetoothPairingRequest clear() {
      phoneAddress = "";
      pairingMethod = info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_1;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.pairingMethod != info.anodsplace.headunit.aap.protocol.nano.Control.BLUETOOTH_PARING_METHOD_1) {
  ...
  public static final class BluetoothPairingResponse extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.BluetoothPairingResponse.BluetoothPairingStatus status = 2;
    public int status;
    ...
    public BluetoothPairingResponse clear() {
      alreadyPaired = false;
      status = info.anodsplace.headunit.aap.protocol.nano.Control.BluetoothPairingResponse.BLUETOOTH_PAIRING_STATUS_1;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.status != info.anodsplace.headunit.aap.protocol.nano.Control.BluetoothPairingResponse.BLUETOOTH_PAIRING_STATUS_1) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Control.BluetoothPairingResponse.BLUETOOTH_PAIRING_STATUS_1:
              case info.anodsplace.headunit.aap.protocol.nano.Control.BluetoothPairingResponse.BLUETOOTH_PAIRING_STATUS_2:
                this.status = value;
                break;
            }
            break;
