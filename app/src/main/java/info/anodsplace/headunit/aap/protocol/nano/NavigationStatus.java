...
public interface NavigationStatus {
  ...
  public static final class NextTurnDetail extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.NextTurnDetail.Side side = 2;
    public int side;

    // required .info.anodsplace.headunit.aap.protocol.NextTurnDetail.NextEvent nextturn = 3;
    public int nextturn;
    ...
    public NextTurnDetail clear() {
      road = "";
      side = info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_LEFT;
      nextturn = info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UNKNOWN;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_LEFT:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_RIGHT:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_UNSPECIFIED:
                this.side = value;
                break;
            }
            break;
          ...
          case 24: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UNKNOWN:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_DEPARTE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_NAME_CHANGE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_SLIGHT_TURN:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_TURN:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_SHARP_TURN:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UTURN:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ONRAMPE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_OFFRAMP:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FORME:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_MERGE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_ENTER:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_EXIT:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_ENTER_AND_EXIT:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_STRAIGHTE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FERRY_BOAT:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FERRY_TRAINE:
              case info.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_DESTINATION:
                this.nextturn = value;
                break;
            }
            break;
