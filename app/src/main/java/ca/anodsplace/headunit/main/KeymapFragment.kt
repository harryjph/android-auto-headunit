 ...
 * @date 13/06/2017
 */
class KeymapFragment : ca.anodsplace.headunit.app.BaseFragment(), MainActivity.KeyListener, View.OnClickListener {
    ...
    override fun onCreateView(inflater: android.view.LayoutInflater, container: android.view.ViewGroup, savedInstanceState: android.os.Bundle?): android.view.View {
        val view = inflater.inflate(ca.anodsplace.headunit.R.layout.fragment_keymap, container, false)
