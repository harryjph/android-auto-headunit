...
public interface Input {
  ...
  public static final class KeyEvent extends
    ...
    // repeated .info.anodsplace.headunit.aap.protocol.Key keys = 1;
    public info.anodsplace.headunit.aap.protocol.nano.Input.Key[] keys;
    ...
    public KeyEvent clear() {
      keys = info.anodsplace.headunit.aap.protocol.nano.Input.Key.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.keys != null && this.keys.length > 0) {
        for (int i = 0; i < this.keys.length; i++) {
          info.anodsplace.headunit.aap.protocol.nano.Input.Key element = this.keys[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            info.anodsplace.headunit.aap.protocol.nano.Input.Key[] newArray =
                new info.anodsplace.headunit.aap.protocol.nano.Input.Key[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.keys, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Input.Key();
  ...
  public static final class TouchEvent extends
    ...
    // repeated .info.anodsplace.headunit.aap.protocol.TouchEvent.Pointer pointer_data = 1;
    public info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer[] pointerData;

    // optional uint32 action_index = 2;
    public int actionIndex;

    // optional .info.anodsplace.headunit.aap.protocol.TouchEvent.PointerAction action = 3;
    public int action;
    ...
    public TouchEvent clear() {
      pointerData = info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer.emptyArray();
      actionIndex = 0;
      action = info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.pointerData != null && this.pointerData.length > 0) {
        for (int i = 0; i < this.pointerData.length; i++) {
          info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer element = this.pointerData[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
      ...
      if (this.action != info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer[] newArray =
                new info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.pointerData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.Pointer();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 24: {
            ...
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_UP:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_MOVE:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_CANCEL:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_OUTSIDE:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_POINTER_DOWN:
              case info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_POINTER_UP:
                this.action = value;
                break;
            }
            break;
  ...
  public static final class RelativeEvent extends
    ...
    // repeated .info.anodsplace.headunit.aap.protocol.RelativeEvent_Rel data = 1;
    public info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel[] data;
    ...
    public RelativeEvent clear() {
      data = info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.data != null && this.data.length > 0) {
        for (int i = 0; i < this.data.length; i++) {
          info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel element = this.data[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel[] newArray =
                new info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.data, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent_Rel();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class AbsoluteEvent extends
    ...
    // repeated .info.anodsplace.headunit.aap.protocol.AbsoluteEvent_Abs data = 1;
    public info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs[] data;
    ...
    public AbsoluteEvent clear() {
      data = info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.data != null && this.data.length > 0) {
        for (int i = 0; i < this.data.length; i++) {
          info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs element = this.data[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
        ...
        switch (tag) {
          ...
          case 10: {
            int arrayLength = com.google.protobuf.nano.WireFormatNano
                .getRepeatedFieldArrayLength(input, 10);
            int i = this.data == null ? 0 : this.data.length;
            info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs[] newArray =
                new info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.data, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent_Abs();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class InputReport extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.TouchEvent touch_event = 3;
    public info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent touchEvent;

    // optional .info.anodsplace.headunit.aap.protocol.KeyEvent key_event = 4;
    public info.anodsplace.headunit.aap.protocol.nano.Input.KeyEvent keyEvent;

    // optional .info.anodsplace.headunit.aap.protocol.AbsoluteEvent absolute_event = 5;
    public info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent absoluteEvent;

    // optional .info.anodsplace.headunit.aap.protocol.RelativeEvent relative_event = 6;
    public info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent relativeEvent;

    // optional .info.anodsplace.headunit.aap.protocol.TouchEvent touchpad_event = 7;
    public info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent touchpadEvent;
    ...
    public InputReport mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 26: {
            if (this.touchEvent == null) {
              this.touchEvent = new info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent();
            }
          ...
          case 34: {
            if (this.keyEvent == null) {
              this.keyEvent = new info.anodsplace.headunit.aap.protocol.nano.Input.KeyEvent();
            }
          ...
          case 42: {
            if (this.absoluteEvent == null) {
              this.absoluteEvent = new info.anodsplace.headunit.aap.protocol.nano.Input.AbsoluteEvent();
            }
          ...
          case 50: {
            if (this.relativeEvent == null) {
              this.relativeEvent = new info.anodsplace.headunit.aap.protocol.nano.Input.RelativeEvent();
            }
          ...
          case 58: {
            if (this.touchpadEvent == null) {
              this.touchpadEvent = new info.anodsplace.headunit.aap.protocol.nano.Input.TouchEvent();
            }
