...
public interface Input {
  ...
  public static final class KeyEvent extends
    ...
    public ca.yyx.hu.aap.protocol.nano.Input.Key[] keys;
    ...
    public KeyEvent clear() {
      keys = ca.yyx.hu.aap.protocol.nano.Input.Key.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.keys != null && this.keys.length > 0) {
        for (int i = 0; i < this.keys.length; i++) {
          ca.yyx.hu.aap.protocol.nano.Input.Key element = this.keys[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            ca.yyx.hu.aap.protocol.nano.Input.Key[] newArray =
                new ca.yyx.hu.aap.protocol.nano.Input.Key[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.keys, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.yyx.hu.aap.protocol.nano.Input.Key();
  ...
  public static final class TouchEvent extends
    ...
    public ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer[] pointerData;
    ...
    public TouchEvent clear() {
      pointerData = ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer.emptyArray();
      actionIndex = 0;
      action = ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.pointerData != null && this.pointerData.length > 0) {
        for (int i = 0; i < this.pointerData.length; i++) {
          ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer element = this.pointerData[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
      ...
      if (this.action != ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer[] newArray =
                new ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.pointerData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.Pointer();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 24: {
            ...
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_DOWN:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_UP:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_MOVE:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_CANCEL:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_OUTSIDE:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_POINTER_DOWN:
              case ca.yyx.hu.aap.protocol.nano.Input.TouchEvent.TOUCH_ACTION_POINTER_UP:
                this.action = value;
                break;
            }
            break;
  ...
  public static final class RelativeEvent extends
    ...
    public ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel[] data;
    ...
    public RelativeEvent clear() {
      data = ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.data != null && this.data.length > 0) {
        for (int i = 0; i < this.data.length; i++) {
          ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel element = this.data[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel[] newArray =
                new ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.data, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent_Rel();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class AbsoluteEvent extends
    ...
    public ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs[] data;
    ...
    public AbsoluteEvent clear() {
      data = ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.data != null && this.data.length > 0) {
        for (int i = 0; i < this.data.length; i++) {
          ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs element = this.data[i];
          if (element != null) {
            output.writeMessage(1, element);
          }
        }
        ...
        switch (tag) {
          ...
          case 10: {
            int arrayLength = com.google.protobuf.nano.WireFormatNano
                .getRepeatedFieldArrayLength(input, 10);
            int i = this.data == null ? 0 : this.data.length;
            ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs[] newArray =
                new ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.data, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent_Abs();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class InputReport extends
    ...
    public ca.yyx.hu.aap.protocol.nano.Input.TouchEvent touchEvent;

    // optional .ca.yyx.hu.aap.protocol.KeyEvent key_event = 4;
    public ca.yyx.hu.aap.protocol.nano.Input.KeyEvent keyEvent;

    // optional .ca.yyx.hu.aap.protocol.AbsoluteEvent absolute_event = 5;
    public ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent absoluteEvent;

    // optional .ca.yyx.hu.aap.protocol.RelativeEvent relative_event = 6;
    public ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent relativeEvent;

    // optional .ca.yyx.hu.aap.protocol.TouchEvent touchpad_event = 7;
    public ca.yyx.hu.aap.protocol.nano.Input.TouchEvent touchpadEvent;
    ...
    public InputReport mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 26: {
            if (this.touchEvent == null) {
              this.touchEvent = new ca.yyx.hu.aap.protocol.nano.Input.TouchEvent();
            }
          ...
          case 34: {
            if (this.keyEvent == null) {
              this.keyEvent = new ca.yyx.hu.aap.protocol.nano.Input.KeyEvent();
            }
          ...
          case 42: {
            if (this.absoluteEvent == null) {
              this.absoluteEvent = new ca.yyx.hu.aap.protocol.nano.Input.AbsoluteEvent();
            }
          ...
          case 50: {
            if (this.relativeEvent == null) {
              this.relativeEvent = new ca.yyx.hu.aap.protocol.nano.Input.RelativeEvent();
            }
          ...
          case 58: {
            if (this.touchpadEvent == null) {
              this.touchpadEvent = new ca.yyx.hu.aap.protocol.nano.Input.TouchEvent();
            }
