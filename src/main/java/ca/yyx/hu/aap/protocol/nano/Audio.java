...
public interface Audio {
  ...
  public static final class AudioFocusRequestNotification extends
    ...
    public AudioFocusRequestNotification clear() {
      request = ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.request != ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_RELEASE:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_NONE:
                this.request = value;
                break;
            }
            break;
  ...
  public static final class AudioFocusNotification extends
    ...
    public AudioFocusNotification clear() {
      focusState = ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN;
      unsolicited = false;
      cachedSize = -1;
      return this;
    }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT_CAN_DUCK:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_MEDIA_ONLY:
              case ca.yyx.hu.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT_GUIDANCE_ONLY:
