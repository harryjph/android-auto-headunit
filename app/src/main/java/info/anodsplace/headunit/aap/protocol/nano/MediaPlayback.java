...
public interface MediaPlayback {
  ...
  public static final class MediaPlaybackStatus extends
    ...
    // optional .info.anodsplace.headunit.aap.protocol.MediaPlaybackStatus.State state = 1;
    public int state;
    ...
    public MediaPlaybackStatus clear() {
      state = info.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE;
      source = "";
      seconds = 0;
      shuffle = false;
      repeat = false;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.state != info.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE:
              case info.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_STOPPED:
              case info.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PLAYING:
                this.state = value;
                break;
            }
            break;
