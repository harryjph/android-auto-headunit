...
public interface MediaPlayback {
  ...
  public static final class MediaPlaybackStatus extends
    ...
    public MediaPlaybackStatus clear() {
      state = ca.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE;
      source = "";
      seconds = 0;
      shuffle = false;
      repeat = false;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.state != ca.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case ca.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PAUSE:
              case ca.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_STOPPED:
              case ca.anodsplace.headunit.aap.protocol.nano.MediaPlayback.MediaPlaybackStatus.MEDIA_SERVICE_STATE_PLAYING:
                this.state = value;
                break;
            }
            break;
