...
public interface Media {
  ...
  public static final class VideoFocusRequestNotification extends
    ...
    public VideoFocusRequestNotification clear() {
      dispChannelId = 0;
      mode = ca.yyx.hu.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_1;
      reason = ca.yyx.hu.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.reason != ca.yyx.hu.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_1:
              case ca.yyx.hu.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_2:
                this.mode = value;
                break;
            }
            break;
          ...
          case 24: {
            int value = input.readInt32();
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1:
              case ca.yyx.hu.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_2:
                this.reason = value;
                break;
            }
            break;
  ...
  public static final class Config extends
    ...
    public Config clear() {
      status = ca.yyx.hu.aap.protocol.nano.Media.Config.CONFIG_STATUS_DEVICE;
      maxUnacked = 0;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case ca.yyx.hu.aap.protocol.nano.Media.Config.CONFIG_STATUS_DEVICE:
              case ca.yyx.hu.aap.protocol.nano.Media.Config.CONFIG_STATUS_HEADUNIT:
                this.status = value;
                break;
            }
            break;
