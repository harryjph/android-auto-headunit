...
public interface Sensors {
  ...
  public static final class SensorBatch extends
    ...
    public static final class GpsSatelliteData extends
      ...
      public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite[] satellites;
      ...
      public GpsSatelliteData clear() {
        numberInUse = 0;
        numberInView = 0;
        satellites = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite.emptyArray();
        cachedSize = -1;
        return this;
      }
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        ...
        if (this.satellites != null && this.satellites.length > 0) {
          for (int i = 0; i < this.satellites.length; i++) {
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite element = this.satellites[i];
            if (element != null) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite[] newArray =
                  new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite[i + arrayLength];
              if (i != 0) {
                java.lang.System.arraycopy(this.satellites, 0, newArray, 0, i);
              }
              for (; i < newArray.length - 1; i++) {
                newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.GpsSatellite();
    ...
    public static final class GearData extends
      ...
      public GearData clear() {
        gear = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_DRIVE;
        cachedSize = -1;
        return this;
      }
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              switch (value) {
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_DRIVE:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_EIGHTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_FIFTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_FIRST:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_FOURTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_NEUTRAL:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_NINTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_PARK:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_REVERSE:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_SECOND:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_SEVENTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_SIXTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_TENTH:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.GEAR_THIRD:
                  this.gear = value;
                  break;
              }
              break;
    ...
    public static final class LightData extends
      ...
      public LightData clear() {
        headlight = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_0;
        turnIndicator = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_0;
        hazardLightOn = false;
        cachedSize = -1;
        return this;
      }
      ...
      public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
          throws java.io.IOException {
        if (this.headlight != ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_0) {
          output.writeInt32(1, this.headlight);
        }
        if (this.turnIndicator != ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_0) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              int value = input.readInt32();
              switch (value) {
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_0:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_1:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_2:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.HEADLIGHT_STATE_3:
            ...
            case 16: {
              int value = input.readInt32();
              switch (value) {
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_0:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_1:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_2:
                case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.TURN_INDICATOR_STATE_3:
    ...
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData[] locationData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.CompassData compass_data = 2;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData[] compassData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.SpeedData speed_data = 3;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData[] speedData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.RpmData rpm = 4;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData[] rpm;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.OdometerData odometer_data = 5;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData[] odometerData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.FuelData fuel_data = 6;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData[] fuelData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.ParkingBrakeData parkingbrake_data = 7;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData[] parkingbrakeData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.GearData gear_data = 8;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData[] gearData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.DiagnosticsData diagnostics_data = 9;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData[] diagnosticsData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.NightModeData night_mode = 10;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData[] nightMode;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.EnvironmentData enviorment_data = 11;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData[] enviormentData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.HvacData hvac_data = 12;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData[] hvacData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.DrivingStatusData driving_status = 13;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData[] drivingStatus;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.DeadReckoningData dead_reckoning = 14;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData[] deadReckoning;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.PassengerData passenger_data = 15;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData[] passengerData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.DoorData door_data = 16;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData[] doorData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.LightData light_data = 17;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData[] lightData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.AccelerometerData accel_data = 19;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData[] accelData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.GyroscopeData gyro_data = 20;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData[] gyroData;

    // repeated .ca.yyx.hu.aap.protocol.SensorBatch.GpsSatelliteData gps_satellite_data = 21;
    public ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData[] gpsSatelliteData;
    ...
    public SensorBatch clear() {
      locationData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData.emptyArray();
      compassData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData.emptyArray();
      speedData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData.emptyArray();
      rpm = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData.emptyArray();
      odometerData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData.emptyArray();
      fuelData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData.emptyArray();
      parkingbrakeData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData.emptyArray();
      gearData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData.emptyArray();
      diagnosticsData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData.emptyArray();
      nightMode = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData.emptyArray();
      enviormentData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData.emptyArray();
      hvacData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData.emptyArray();
      drivingStatus = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData.emptyArray();
      deadReckoning = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData.emptyArray();
      passengerData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData.emptyArray();
      doorData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData.emptyArray();
      lightData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData.emptyArray();
      accelData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData.emptyArray();
      gyroData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData.emptyArray();
      gpsSatelliteData = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData.emptyArray();
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.locationData != null && this.locationData.length > 0) {
        for (int i = 0; i < this.locationData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData element = this.locationData[i];
          if (element != null) {
      ...
      if (this.compassData != null && this.compassData.length > 0) {
        for (int i = 0; i < this.compassData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData element = this.compassData[i];
          if (element != null) {
      ...
      if (this.speedData != null && this.speedData.length > 0) {
        for (int i = 0; i < this.speedData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData element = this.speedData[i];
          if (element != null) {
            output.writeMessage(3, element);
          }
        }
      ...
      if (this.rpm != null && this.rpm.length > 0) {
        for (int i = 0; i < this.rpm.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData element = this.rpm[i];
          if (element != null) {
      ...
      if (this.odometerData != null && this.odometerData.length > 0) {
        for (int i = 0; i < this.odometerData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData element = this.odometerData[i];
          if (element != null) {
      ...
      if (this.fuelData != null && this.fuelData.length > 0) {
        for (int i = 0; i < this.fuelData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData element = this.fuelData[i];
          if (element != null) {
      ...
      if (this.parkingbrakeData != null && this.parkingbrakeData.length > 0) {
        for (int i = 0; i < this.parkingbrakeData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData element = this.parkingbrakeData[i];
          if (element != null) {
      ...
      if (this.gearData != null && this.gearData.length > 0) {
        for (int i = 0; i < this.gearData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData element = this.gearData[i];
          if (element != null) {
      ...
      if (this.diagnosticsData != null && this.diagnosticsData.length > 0) {
        for (int i = 0; i < this.diagnosticsData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData element = this.diagnosticsData[i];
          if (element != null) {
      ...
      if (this.nightMode != null && this.nightMode.length > 0) {
        for (int i = 0; i < this.nightMode.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData element = this.nightMode[i];
          if (element != null) {
      ...
      if (this.enviormentData != null && this.enviormentData.length > 0) {
        for (int i = 0; i < this.enviormentData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData element = this.enviormentData[i];
          if (element != null) {
      ...
      if (this.hvacData != null && this.hvacData.length > 0) {
        for (int i = 0; i < this.hvacData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData element = this.hvacData[i];
          if (element != null) {
      ...
      if (this.drivingStatus != null && this.drivingStatus.length > 0) {
        for (int i = 0; i < this.drivingStatus.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData element = this.drivingStatus[i];
          if (element != null) {
      ...
      if (this.deadReckoning != null && this.deadReckoning.length > 0) {
        for (int i = 0; i < this.deadReckoning.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData element = this.deadReckoning[i];
          if (element != null) {
      ...
      if (this.passengerData != null && this.passengerData.length > 0) {
        for (int i = 0; i < this.passengerData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData element = this.passengerData[i];
          if (element != null) {
      ...
      if (this.doorData != null && this.doorData.length > 0) {
        for (int i = 0; i < this.doorData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData element = this.doorData[i];
          if (element != null) {
      ...
      if (this.lightData != null && this.lightData.length > 0) {
        for (int i = 0; i < this.lightData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData element = this.lightData[i];
          if (element != null) {
      ...
      if (this.accelData != null && this.accelData.length > 0) {
        for (int i = 0; i < this.accelData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData element = this.accelData[i];
          if (element != null) {
      ...
      if (this.gyroData != null && this.gyroData.length > 0) {
        for (int i = 0; i < this.gyroData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData element = this.gyroData[i];
          if (element != null) {
      ...
      if (this.gpsSatelliteData != null && this.gpsSatelliteData.length > 0) {
        for (int i = 0; i < this.gpsSatelliteData.length; i++) {
          ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData element = this.gpsSatelliteData[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.locationData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LocationData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 18: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.compassData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.CompassData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 26: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.speedData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.SpeedData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 34: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.rpm, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.RpmData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 42: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.odometerData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.OdometerData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 50: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.fuelData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.FuelData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 58: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.parkingbrakeData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.ParkingBrakeData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 66: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.gearData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GearData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 74: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.diagnosticsData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DiagnosticsData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 82: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.nightMode, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.NightModeData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 90: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.enviormentData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.EnvironmentData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 98: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.hvacData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.HvacData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 106: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.drivingStatus, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DrivingStatusData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 114: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.deadReckoning, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DeadReckoningData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 122: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.passengerData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.PassengerData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 130: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.doorData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.DoorData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 138: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.lightData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.LightData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 154: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.accelData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.AccelerometerData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 162: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.gyroData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GyroscopeData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
          ...
          case 170: {
            ...
            ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData[] newArray =
                new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.gpsSatelliteData, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new ca.anodsplace.headunit.aap.protocol.nano.Sensors.SensorBatch.GpsSatelliteData();
              input.readMessage(newArray[i]);
              input.readTag();
            }
            // Last one without readTag.
  ...
  public static final class SensorRequest extends
    ...
    public SensorRequest clear() {
      type = ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_LOCATION;
      minUpdatePeriod = 0L;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.type != ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_LOCATION) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_LOCATION:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_COMPASS:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_CAR_SPEED:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_RPM:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_ODOMETER:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_FUEL_LEVEL:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_PARKING_BRAKE:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_GEAR:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_DIAGNOSTICS:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_NIGHT:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_ENVIRONMENT:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_HVAC:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_DRIVING_STATUS:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_DEAD_RECONING:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_PASSENGER:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_DOOR:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_LIGHT:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_TIRE:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_ACCEL:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_GYRO:
              case ca.anodsplace.headunit.aap.protocol.nano.Sensors.SENSOR_TYPE_GPS:
                this.type = value;
                break;
            }
            break;
