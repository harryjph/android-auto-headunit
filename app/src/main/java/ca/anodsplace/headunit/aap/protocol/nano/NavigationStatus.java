...
public interface NavigationStatus {
  ...
  public static final class NextTurnDetail extends
    ...
    public NextTurnDetail clear() {
      road = "";
      side = ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_LEFT;
      nextturn = ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UNKNOWN;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            switch (value) {
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_LEFT:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_RIGHT:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.SIDE_UNSPECIFIED:
                this.side = value;
                break;
            }
            break;
          ...
          case 24: {
            int value = input.readInt32();
            switch (value) {
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UNKNOWN:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_DEPARTE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_NAME_CHANGE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_SLIGHT_TURN:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_TURN:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_SHARP_TURN:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_UTURN:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ONRAMPE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_OFFRAMP:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FORME:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_MERGE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_ENTER:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_EXIT:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_ROUNDABOUT_ENTER_AND_EXIT:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_STRAIGHTE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FERRY_BOAT:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_FERRY_TRAINE:
              case ca.anodsplace.headunit.aap.protocol.nano.NavigationStatus.NextTurnDetail.EVENT_DESTINATION:
                this.nextturn = value;
                break;
            }
            break;
