...
public interface Media {
  ...
  public static final class VideoFocusRequestNotification extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.VideoFocusMode mode = 2;
    public int mode;

    // optional .info.anodsplace.headunit.aap.protocol.VideoFocusRequestNotification.VideoFocusReason reason = 3;
    public int reason;
    ...
    public VideoFocusRequestNotification clear() {
      dispChannelId = 0;
      mode = info.anodsplace.headunit.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_1;
      reason = info.anodsplace.headunit.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.reason != info.anodsplace.headunit.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_1:
              case info.anodsplace.headunit.aap.protocol.nano.Media.VIDEO_FOCUS_MODE_2:
                this.mode = value;
                break;
            }
            break;
          ...
          case 24: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_1:
              case info.anodsplace.headunit.aap.protocol.nano.Media.VideoFocusRequestNotification.VIDEO_FOCUS_REASON_2:
                this.reason = value;
                break;
            }
            break;
  ...
  public static final class VideoFocusNotification extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.VideoFocusMode mode = 1;
    public int mode;
  ...
  public static final class Config extends
    ...
    // required .info.anodsplace.headunit.aap.protocol.Config.ConfigStatus status = 1;
    public int status;
    ...
    public Config clear() {
      status = info.anodsplace.headunit.aap.protocol.nano.Media.Config.CONFIG_STATUS_DEVICE;
      maxUnacked = 0;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Media.Config.CONFIG_STATUS_DEVICE:
              case info.anodsplace.headunit.aap.protocol.nano.Media.Config.CONFIG_STATUS_HEADUNIT:
                this.status = value;
                break;
            }
            break;
