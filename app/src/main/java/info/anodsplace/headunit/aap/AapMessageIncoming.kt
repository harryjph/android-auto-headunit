...
internal class AapMessageIncoming(header: EncryptedHeader, data: ByteArray) : AapMessage(header.chan, header.flags.toByte(), Utils.bytesToInt(data, 0, true), calcOffset(), data.size, data) {
