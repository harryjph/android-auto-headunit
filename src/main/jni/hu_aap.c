...
int hu_aap_tra_send(byte *buf, int len,
...
int aa_pro_all_a07(int chan, byte *buf, int len) {                  // Channel Open Request
    if (len != 6 || buf[2] != 0x08 || buf[4] != 0x10)
        ...
        logd ("Channel Open Request: %d  chan: %d", buf[3],
              buf[5]);    // R 1 SEN f 00000000 08 00 10 01   R 2 VID f 00000000 08 00 10 02   R 3 TOU f 00000000 08 00 10 03   R 4 AUD f 00000000 08 00 10 04   R 5 MIC f 00000000 08 00 10 05
    ...
    if (chan == AA_CH_SEN) {                                            // If Sensor channel...
        ms_sleep(2);//20);
        byte rspds[] = {0x80, 0x03, 0x6a, 2, 8,
                        0};                      // Driving Status = 0 = Parked (1 = Moving)
...
int aa_pro_sen_b01(int chan, byte *buf, int len) {                  // Sensor Start Request...
    ...
    int ret = hu_aap_enc_send(chan, rsp,
                              sizeof(rsp));                  // Send Sensor Start Response
//    if (ret)                                                            // If error, done with error
    return (ret);
...
int aa_pro_tou_b02(int chan, byte *buf,
                   int len) {                  // TouchScreen/Input Start Request...    Or "send setup, ch:X" for channel X
    if (len < 2 || len > 256)
...
int aa_pro_mic_b05(int chan, byte *buf, int len) {
    ...
    else if (len != 10 || buf[2] != 0x08 || buf[3] != 1 || buf[4] != 0x10 || buf[6] != 0x18 ||
             buf[8] != 0x20) {
...
aa_type_ptr_t aa_type_array[
        AA_CH_MAX + 1][3][32] = {              // 0 - 31, 32768-32799, 65504-65535
                // Sync with hu_tra.java, hu_aap.h and hu_aap.c:aa_type_array[]
// Channel 0 Ctr Control:
                aa_pro_ctr_a00, aa_pro_ctr_a01, aa_pro_ctr_a02, aa_pro_ctr_a03, aa_pro_ctr_a04,
                aa_pro_ctr_a05, aa_pro_ctr_a06, aa_pro_all_a07, aa_pro_ctr_a08, aa_pro_ctr_a09,
                aa_pro_ctr_a0a, aa_pro_ctr_a0b, aa_pro_ctr_a0c, aa_pro_ctr_a0d, aa_pro_ctr_a0e,
                aa_pro_ctr_a0f,
                aa_pro_ctr_a10, aa_pro_ctr_a11, aa_pro_ctr_a12, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL,
                NULL,   //    a10, a11, a12, aa_pro_ctr_a13, aa_pro_ctr_a14, aa_pro_ctr_a15, aa_pro_ctr_a16, aa_pro_ctr_a17, aa_pro_ctr_a18, aa_pro_ctr_a19, aa_pro_ctr_a1a, aa_pro_ctr_a1b, aa_pro_ctr_a1c, aa_pro_ctr_a1d, aa_pro_ctr_a1e, aa_pro_ctr_a1f,
...
// Channel 1 Sen Sensor:
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, aa_pro_all_a07, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, aa_pro_sen_b01, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
// Channel 2 Vid Video:
                ...
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                aa_pro_snk_b00, aa_pro_vid_b01, NULL, NULL, NULL, NULL, NULL, aa_pro_vid_b07, NULL,
...
// Channel 3 Tou TouchScreen:
                ...
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, NULL, aa_pro_tou_b02, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
// Channel 4 Output Audio:
                ...
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                aa_pro_snk_b00, aa_pro_aud_b01, aa_pro_aud_b02, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
// Channel 7 Mic Audio:
                ...
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, aa_pro_mic_b01, NULL, NULL, aa_pro_mic_b04, aa_pro_mic_b05, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL,
                NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
//        logd ("audio q_buf: %p  buf: %p  len: %d", q_buf, buf, len);
    if (q_buf == NULL) {
        ...
        if (0) {//chan == AA_CH_AU1 || chan == AA_CH_AU2) {
            ...
            int idxi = 0;
            for (idx = 0; idx <
                          len; idx += 12) {                          // Convert 16K mono to 48k stereo equivalent; interpolation would be better
...
byte aud_ack[] = {0x80, 0x04, 0x08, 0, 0x10,
                  1};                    // Global Ack: 0, 1     Same as video ack ?

//int aud_ack_ctr = 0;
int iaap_audio_process(int chan, int msg_type, int flags, byte *buf,
                       int len) { // 300 ms @ 48000/sec   samples = 14400     stereo 16 bit results in bytes = 57600
...
*/
        iaap_audio_decode(chan, &buf[10], len -
                                          10);//assy, assy_size);                                                                                    // Decode PCM audio fully re-assembled
    }
...
//*/
    if (0) {
        ...
        iaap_video_decode(&buf[10], len -
                                    10);                                                                               // Decode H264 video
    }
    ...
    else if (flags == 11 && msg_type == 1 && (buf[2] == 0 && buf[3] == 0 && buf[4] == 0 && buf[5] ==
                                                                                           1)) {                     // If Not fragmented First video config packet
        iaap_video_decode(&buf[2], len -
                                   2);                                                                                 // Decode H264 video
    }
    else if (flags ==
             8) {                                                                                                     // If Middle fragment Video
        memcpy(&assy[assy_size], buf, len);
        assy_size += len;                                                                                                       // Add to re-assembly in progress
    }
    else if (flags ==
             10) {                                                                                                    // If Last fragment Video
        memcpy(&assy[assy_size], buf, len);
        assy_size += len;                                                                                                       // Add to re-assembly in progress
        iaap_video_decode(assy,
                          assy_size);                                                                                    // Decode H264 video fully re-assembled
    }
    else
...
int iaap_msg_process(int chan, int flags, byte *buf, int len) {
    ...
    if ((chan == AA_CH_AUD || chan == AA_CH_AU1 || chan == AA_CH_AU2) && (msg_type == 0 ||
                                                                          msg_type ==
                                                                          1)) {// || flags == 8 || flags == 9 || flags == 10 ) {         // If Audio Output...
...
int iaap_recv_dec_process(int chan, int flags, byte *buf,
    ...
    while (bytes_read <= 0 && ctr++ < max_tries) {
        bytes_read = SSL_read(hu_ssl_ssl, dec_buf,
...
//            hex_dump("LR: ", 16, buf, have_len);
        ...
        if (chan == AA_CH_VID && flags == 9) {                            // If First fragment Video... (Packet is encrypted so we can't get the real msg_type or check for 0, 0, 0, 1)
            ...
            if (total_size >
                max_assy_size)                                 // If new  max_assy_size... (total_size seen as big as 151 Kbytes)
