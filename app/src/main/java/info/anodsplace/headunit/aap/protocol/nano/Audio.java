...
public interface Audio {
  ...
  public static final class AudioFocusRequestNotification extends
    ...
    public AudioFocusRequestNotification clear() {
      request = info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.request != info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_RELEASE:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusRequestNotification.AUDIOFOCUS_NONE:
                this.request = value;
                break;
            }
            break;
  ...
  public static final class AudioFocusNotification extends
    ...
    public AudioFocusNotification clear() {
      focusState = info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN;
      unsolicited = false;
      cachedSize = -1;
      return this;
    }
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            int value = input.readInt32();
            switch (value) {
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT_CAN_DUCK:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_LOSS_TRANSIENT:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_MEDIA_ONLY:
              case info.anodsplace.headunit.aap.protocol.nano.Audio.AudioFocusNotification.AUDIOFOCUS_STATE_GAIN_TRANSIENT_GUIDANCE_ONLY:
