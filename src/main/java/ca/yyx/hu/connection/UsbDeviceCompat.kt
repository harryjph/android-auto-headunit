...
class UsbDeviceCompat(val wrappedDevice: UsbDevice) {
    ...
    companion object {
        ...
        private const val USB_VID_PAN = 0x10a9
        private const val USB_VID_ZTE = 0x19d2
        private const val USB_VID_GAR = 0x091e
        private const val USB_VID_XIA = 0x2717
        private const val USB_VID_ASU = 0x0b05
        private const val USB_VID_MEI = 0x2a45
        private const val USB_VID_LEN = 0x17ef
        private const val USB_VID_LGD = 0x1004
        private const val USB_VID_LIN = 0x1d6b
        private const val USB_VID_QUA = 0x05c6
        private const val USB_VID_ONE = 0x2a70
        private const val USB_VID_COM = 0x1519  // Comneon

        private const val USB_VID_ASE = 0x0835  // Action Star Enterprise
        private const val USB_VID_OPO = 0x22d9  // Oppo


        private const val USB_PID_ACC_MIN = 0x2D00      // 11520   Product ID to use when in accessory mode without ADB
        private const val USB_PID_ACC_MAX = 0x2D05

        private const val USB_PID_ACC = 0x2D00      // Accessory                  100
        private const val USB_PID_ACC_ADB = 0x2D01      // Accessory + ADB            110
        private const val USB_PID_AUD = 0x2D02      //                   Audio    001
        private const val USB_PID_AUD_ADB = 0x2D03      //             ADB + Audio    011
        private const val USB_PID_ACC_AUD = 0x2D04      // Accessory       + Audio    101
        private const val USB_PID_ACC_AUD_ADB = 0x2D05      // Accessory + ADB + Audio    111
